...
public class Audiogram {
    ...
    public Audiogram(String username, int f125Left, int f250Left, int f500Left
            , int f1000Left, int f2000Left, int f3000Left, int f4000Left, int f8000Left
            , int f125Right, int f250Right, int f500Right, int f1000Right, int f2000Right
            , int f3000Right, int f4000Right, int f8000Right, Date date) throws ParseException {
    ...
    public Audiogram(int id, String username, int f125Left, int f250Left, int f500Left, int f1000Left
            , int f2000Left, int f3000Left, int f4000Left, int f8000Left, int f125Right, int f250Right
            , int f500Right, int f1000Right, int f2000Right, int f3000Right, int f4000Right, int f8000Right, Date date) {
        this.id = id;
        this.username = username;
        this.f125Left = f125Left;
        this.f250Left = f250Left;
